...
/* NACK reception interrupt enable (NAKI) */
...
#define _00_IIC_RECEIVE_DATA_INTERRUPT_DISABLE       (0x00U) /* Receive data full interrupt (ICRXI) disabled */
#define _20_IIC_RECEIVE_DATA_INTERRUPT_ENABLE        (0x20U) /* Receive data full interrupt (ICRXI) enabled */
/* Transmit end interrupt enable (TEIE) */
#define _00_IIC_TRANSMIT_END_INTERRUPT_DISABLE       (0x00U) /* Transmit end interrupt (ICTEI) disabled */
#define _40_IIC_TRANSMIT_END_INTERRUPT_ENABLE        (0x40U) /* Transmit end interrupt (ICTEI) enabled */
/* Transmit data empty interrupt enable (TIE) */
#define _00_IIC_TRANSMIT_EMPTY_INTERRUPT_DISABLE     (0x00U) /* Transmit data empty interrupt (ICTXI) disabled */
#define _80_IIC_TRANSMIT_EMPTY_INTERRUPT_ENABLE      (0x80U) /* Transmit data empty interrupt (ICTXI) enabled */
...
Macro definitions
***********************************************************************************************************************/
#define _FD_IIC0_SCL_HIGH_LEVEL_PERIOD               (0xFDU) /* SCL clock high-level period setting */
